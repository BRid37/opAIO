...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    self.STEER_STEP = 1  # 100 Hz
      ...
      self.STEER_MAX = 409  # Increased from 270 to match opendbc safety max_torque
      self.STEER_DRIVER_ALLOWANCE = 250
      self.STEER_DRIVER_MULTIPLIER = 2
      self.STEER_THRESHOLD = 250
      self.STEER_DELTA_UP = 3  # Increased from 2 for faster torque ramp-up
      self.STEER_DELTA_DOWN = 8  # Increased from 3 for faster torque ramp-down
