...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme, started, boot_run=False):
    ...
    toggle.automatic_updates = params.get_bool("AutomaticUpdates") if tuning_level >= level["AutomaticUpdates"] and self.release_branch else default.get_bool("AutomaticUpdates")
