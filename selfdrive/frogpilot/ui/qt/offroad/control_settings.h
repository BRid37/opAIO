...
private:
  ...
  std::set<QString> qolKeys = {"MainOnStart", "MuteDM", "MuteDoor", "MuteSeatbelt", "CustomCruise", "CustomCruiseLong", "ForceStandstill", "MapGears", "PauseLateralSpeed", "ReverseCruise", "SetSpeedOffset"};
