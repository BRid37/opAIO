0. This guide describes how to use Logcat to transfer navigation data.
...
6-1. The hotspot IP or gateway IP can be automatically detected. Manual input is no longer required. Enable the feature in the menu.
...
0. 이 가이드는 로그캣을 이용하여 네비데이터를 전송하는 방법을 설명합니다.
...
6-1. 핫스팟 IP혹은 게이트웨이 IP를 자동으로 잡을 수 있도록 추가하였습니다. 수동입력이 필요없습니다. 메뉴에서 기능을 켜세요.
